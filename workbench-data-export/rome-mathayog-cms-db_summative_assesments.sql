...
CREATE TABLE `summative_assesments` (
  ...
  `summative_assesment_title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `summative_assesments` VALUES (1,'Summative Assessment - WN-P2-A1-SA01','Summative Assessment',2,13,NULL,NULL);
